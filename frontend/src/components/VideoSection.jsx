...
import { getVideos, uploadVideo } from '../services/videoService';
import { Play, Plus, Video, Search, ChevronRight, Loader2, X } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {videos.map(video => (
                            <div key={video.id} className="bg-surface rounded-3xl overflow-hidden border border-border group hover:border-primary/50 transition-all">
